/* eslint-disable */
import {Object3D,TextureLoader,LinearFilter,RGBFormat,Vector2,RawShaderMaterial,AdditiveBlending,InstancedBufferGeometry,BufferAttribute,InstancedBufferAttribute,Mesh,PlaneGeometry,MeshBasicMaterial} from 'three';
...
export default class Particles {
    ...
    show(time = 1.0) {
        ...
        // TweenLite.fromTo(this.object3D.material.uniforms.uSize, time, { value: 1.28 }, { value: 1.5 });
        // TweenLite.to(this.object3D.material.uniforms.uRandom, time, { value: 10.0 });
        // TweenLite.fromTo(this.object3D.material.uniforms.uDepth, time * 1.5, { value: 40.0 }, { value: 8.0 });

        TweenLite.fromTo(this.object3D.material.uniforms.uSize, time, { value: 0.5 }, { value: 0.8 });
        TweenLite.to(this.object3D.material.uniforms.uRandom, time, { value: 5.0 });
        TweenLite.fromTo(this.object3D.material.uniforms.uDepth, time*1.5 , { value: 40.0 }, { value: 13.0 });
