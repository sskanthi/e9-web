                    ...
                    <div class="col-lg-4">
                        <div class="address-wrapper p-5 p-lg-4 p-xl-5 mb-4 mb-lg-0 d-flex align-items-center">
                            <div>
                                ...
                                <p class="lead text-white mb-0">14 Great College Street
                                    <br> Westminster
                                    <br> London
                                    <br> SW1P 3RX
                                    <br> 
                    ...
                    <div class="col-lg-4">
                        <div class="address-wrapper p-5 p-lg-4 p-xl-5 mb-4 mb-lg-0 d-flex align-items-center">
                            <div>
                                ...
                                <p class="lead text-white mb-0">1 St Katharine's Way
                                    <br> Tower Bridge
                                    <br> London
                                    <br> E1W 1UN
                                    <br> 
                    ...
                    <div class="col-lg-4">
                        <div class="address-wrapper  p-5 p-lg-4 p-xl-5 mb-4 mb-lg-0 d-flex align-items-center">
                            <div>
                                ...
                                <p class="lead text-white mb-0"> Houldsworth Business and Arts Centre
                                    <br>Houldsworth St
                                    <br> Reddish SK5 6DA
                                    <br>
                                    <br>
                    ...
                    <div class="col-lg-4">
                        <div class="address-wrapper  p-5 p-lg-4 p-xl-5 mb-4 mb-lg-0  d-flex align-items-center">
                            <div>
                                ...
                                <p class="lead text-white mb-0"> The Hive (Level 5) 
                                    <br> VR Bengaluru
...
export default {
    ...
    mounted() {
        ...
        let map2 = new window.google.maps.Map(document.getElementById('map2'), {
            center: new window.google.maps.LatLng(51.507704, -0.073720),
            zoom: 15,
            mapTypeId: window.google.maps.MapTypeId.ROADMAP,
            styles: MapStyles
        });
        ...
        new window.google.maps.Marker({
            map: map2,
            icon: e9Image,
            position: new window.google.maps.LatLng(51.507704, -0.073720)
        });
        new window.google.maps.Marker({
            map: map3,
            icon: e9Image,
