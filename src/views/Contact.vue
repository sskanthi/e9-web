    ...
    <div>
        ...
        <section class="bg-dark">
            <div class="container">
                ...
                <form class="needs-validation" method="post" name="contact" data-netlify="true" data-netlify-honeypot="bot-field" v-on:submit.prevent="handleSubmit">
                    <input type="hidden" name="form-name" value="contact" />
                    <div class="row mb-5">
                        <div class="col-lg-6">
                            <div class="form-group"><input class="form-control form-control-lg" name="name" type="text" v-model="formData.name" placeholder="Your Name" required /></div>
                            <div class="form-group"><input class="form-control form-control-lg" name="phone" type="text" v-model="formData.phone" placeholder="Your Phone Number" /></div>
                            <div class="form-group"><input class="form-control form-control-lg" name="email" type="email" v-model="formData.email" placeholder="Your Email" required /></div>
                            <div class="form-group"><input class="form-control form-control-lg" name="company" type="text" v-model="formData.company" placeholder="Your Company" required /></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <textarea id="textarea" class="form-control form-control-lg" name="message" rows="10" v-model="formData.message" placeholder="How can we help?" required></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="address-wrapper p-5 p-lg-4 p-xl-5 mb-4 mb-lg-0 d-flex align-items-center">
                            <div>
                                ...
                                <p class="lead text-white mb-0">
                                    ...
                                    <br />
                                    <br />
                                    <a href="tel:+44 (0) 843 515 8868" class="text-muted">+44 (0) 843 515 8868</a>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="address-wrapper p-5 p-lg-4 p-xl-5 mb-4 mb-lg-0 d-flex align-items-center">
                            <div>
                                ...
                                <p class="lead text-white mb-0">
                                    ...
                                    <br />
                                    <br />
                                    <a href="tel:+44 (0) 843 515 8868" class="font-weight-normal text-muted">+44 (0) 843 515 8868</a>
                                </p>
                            </div>
                        </div>
                    </div>
